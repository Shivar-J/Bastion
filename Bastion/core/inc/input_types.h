...
#ifndef BASTION_INPUT_TYPES_H
#define BASTION_INPUT_TYPES_H
...
// taken from
// https://github.com/AvaloniaUI/Avalonia/blob/main/src/Avalonia.Base/Input/Key.cs
...
inline bool operator==(int32_t lhs, const KeyCode rhs)
{
  return static_cast<KeyCode>(lhs) == rhs;
}

inline bool operator==(int32_t lhs, const MouseCode rhs)
{
  return static_cast<MouseCode>(lhs) == rhs;
}

inline bool operator==(int32_t lhs, const InputType rhs)
{
  return static_cast<InputType>(lhs) == rhs;
}

#endif //BASTION_INPUT_TYPES_H
